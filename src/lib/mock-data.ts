...
export const MOCK_LESSONS: Record<string, MockLesson[]> = {
  ...
  'mod-5': [
    { id: 'les-5-1', titulo: 'Escape 100 kilos', youtube_id: '', descripcion: '', orden: 1, duracion: '14:00', completed: false, tipo: 'video' },
    { id: 'les-5-2', titulo: 'Drill 1: Escape de 100kg', youtube_id: '', descripcion: '', orden: 2, duracion: '8:00', completed: false, tipo: 'video' },
    { id: 'les-5-3', titulo: 'Drill 2: Escape + Combinacion Guardia cerrada', youtube_id: '', descripcion: '', orden: 3, duracion: '10:00', completed: false, tipo: 'video' },
    { id: 'les-5-4', titulo: 'Especifico de 100KG', youtube_id: '', descripcion: '', orden: 4, duracion: '12:00', completed: false, tipo: 'video' },
    { id: 'les-5-5', titulo: 'Reflexion semanal', youtube_id: '', descripcion: 'Responde las preguntas de reflexion de la semana', orden: 5, duracion: '', completed: false, tipo: 'reflection' },
  ],
  'mod-6': [
    ...
    { id: 'les-6-3', titulo: 'Drill 2: Combinacion escape + guardia cerrada', youtube_id: '', descripcion: '', orden: 3, duracion: '10:00', completed: false, tipo: 'video' },
