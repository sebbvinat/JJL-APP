...
const SHARED_MONTH_1: PlanillaWeek[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      v('Toreos Variante 4', '9bapjjLu8z8'),
      v('Drill 1: Guardia cerrada', 'J2Qpa2-KPKo'),
      v('Drill 2: Toreos', 'R3mhOdD-Zck'),
...
const SHARED_MONTH_2: PlanillaWeek[] = [
  {
    ...
    lessons: [
      ...
      v('Drill 2: Escape + Combinación Guardia cerrada', 'q8NkYdIrLXw'),
  ...
  },
  {
    ...
    lessons: [
      ...
      v('Drill 1: 100 KG variante 2', 'fgNu4Pt74hw'),
...
const LIVIANOS_MONTH_3: PlanillaWeek[] = [
  {
    ...
    lessons: [
      ...
      v('Conceptos De la Riva', 'R5cBhca7bvk'),
      v('Leg Trap variante 1'),
      v('De la Riva: Babybolo', 'MF0E-tiAohw'),
      v('Drill 1: Leg Trap'),
      v('Drill: Babybolo', 'rVf9fEAA1hQ'),
      r(),
    ],
  },
  {
    ...
    lessons: [
      ...
      v('De la Riva: Stand Up Sweep'),
      v('Drill 1: Leg Trap'),
      v('Drill: Stand Up Sweep'),
...
const MEDIOS_MONTH_3: PlanillaWeek[] = [
  {
    ...
    lessons: [
      v('Conceptos Pasaje De la Riva', 'Fu8VKpEh1R0'),
      v('Pasaje De la Riva 1', '1puX4ukkyPk'),
      v('Conceptos De la Riva', 'R5cBhca7bvk'),
      v('De la Riva: Babybolo', 'MF0E-tiAohw'),
      v('Drill 1: Pasaje de la Riva', 'hK7M5_dqg6o'),
      v('Drill: Babybolo', 'rVf9fEAA1hQ'),
      r(),
    ],
  },
  ...
  },
  {
    ...
    lessons: [
      v('De la Riva: Push'),
      v('Pasaje De la Riva: Cross Knee'),
      v('Drill: DLR Push'),
      v('Drill: Cross Knee'),
      v('Drill en combinación: De la Riva'),
      v('Juego ecológico: pasaje / guardia'),
