...
export async function GET(request: NextRequest) {
  ...
  // CRÍTICO: NO cachear /api/auth/me. Si el browser cachea esta respuesta
  // y otro user entra al mismo browser (logout/login), el cache puede
  // devolver la identidad anterior → al admin le aparece como alumno.
  // Sin Vary:Cookie no es seguro cachear endpoints de identidad.
  if (error) {
