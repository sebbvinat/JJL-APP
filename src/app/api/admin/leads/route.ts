...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = admin
      ...
      .select(
        'id, session_id, fortaleza, limitacion, estado, vision, compromiso, urgencia, experiencia, telefono, pais, nombre, email, disqualified, booked, user_agent, referrer, created_at',
      )
