...
Cada `<id>.webp` es el avatar circular del quiz "¿A qué luchador te parecés?"
...
|---|---|---|---|
| `marcelo.webp` | Marcelo Garcia | [Commons: Marcelo garcia.jpg](https://commons.wikimedia.org/wiki/File:Marcelo_garcia.jpg) | **Dominio publico** |
| `cobrinha.webp` | Rubens "Cobrinha" Charles | [Commons: Rubens Cobrinha Charles.jpg](https://commons.wikimedia.org/wiki/File:Rubens_Cobrinha_Charles.jpg) | **CC BY-SA 3.0**, autor Dkaivani |
| `gordon.webp` | Gordon Ryan | [BJJ Heroes](https://www.bjjheroes.com/bjj-fighters/gordon-ryan) | sin licencia libre |
| `adam.webp` | Adam Wardzinski | [BJJ Heroes](https://www.bjjheroes.com/bjj-fighters/adam-wardzinski) | sin licencia libre |
| `buchecha.webp` | Marcus "Buchecha" Almeida | [ONE Championship](https://www.onefc.com/athletes/marcus-almeida/) | sin licencia libre |
| `roger.webp` | Roger Gracie | [ONE Championship](https://www.onefc.com/athletes/roger-gracie/) | sin licencia libre |
| `bernardo.webp` | Bernardo Faria | [BJJ Fanatics](https://bjjfanatics.com/collections/bernardo-faria) (su propia empresa) | sin licencia libre |

Solo `cobrinha.webp` obliga a algo: su licencia pide atribuir al autor. Por eso
...
reemplazar sin tocar codigo: alcanza con pisar el WebP.
...
- **`gordon.webp`**: la version anterior (agosto 2026) NO era Gordon Ryan, era
